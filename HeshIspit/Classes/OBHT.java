...
public class OBHT<K extends Comparable<K>, E> {
    ...
    // An object of class Classes.OBHT is an open-bucket hash table, containing entries
    // of class Classes.MapEntry.
    ...
    // ... number of occupied or formerly-occupied buckets in this Classes.OBHT.

    @SuppressWarnings("unchecked")
    public OBHT(int m) {
        // Construct an empty Classes.OBHT with m buckets.
    ...
    public int search(K targetKey) {
        // Find which if any bucket of this Classes.OBHT is occupied by an entry whose key
    ...
    public void insert(K key, E val) {
        // Insert the entry <key, val> into this Classes.OBHT.
    ...
    public void delete(K key) {
        // Delete the entry (if any) whose key is equal to key from this Classes.OBHT.
        int b = hash(key);
        int n_search = 0;
        while (n_search < buckets.length) {
            MapEntry<K, E> currEntry = buckets[b];
